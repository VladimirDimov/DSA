namespace SortingHomework
{
    ...
    internal class Program
    {
        internal static void Main(string[] args)
        {
            ...
            Console.WriteLine("Linear search -15:");
            Console.WriteLine(collection.LinearSearch(-15));
            Console.WriteLine();

            Console.WriteLine("Binary search 101:");
            Console.WriteLine(collection.BinarySearch(101));
            Console.WriteLine("Binary search -15:");
            Console.WriteLine(collection.BinarySearch(-15));
            Console.WriteLine();
